...
const TRANSLATIONS = {
  fr: {
    ...
    services_p:
      "De la conception à la mise en production, nous couvrons tout le spectre de l'IA.",
    serv_cv_title: "Computer Vision",
    serv_cv_sub: "Détection · Reconnaissance · Analyse",
    serv_cv_desc:
      "Analyse d'images et de vidéos en temps réel pour l'automatisation et le contrôle qualité.",
    serv_cta_title: "Un projet en tête ?",
    serv_cta_p:
      "Discutons de vos besoins et construisons ensemble la solution IA.",
    careers_label: "// Carrières",
    careers_h1: "Façonnez l'IA",
    careers_h1_2: "de Demain",
    careers_p:
      "Rejoignez une équipe passionnée qui construit les solutions IA de demain.",
    ...
    careers_no_match:
      "Pas de poste correspondant ? Envoyez une candidature spontanée.",
    careers_spontaneous: "Candidature spontanée",
    blog_label: "// Blog & Actualités",
    blog_h1: "Actualités &",
    blog_h1_2: "Insights IA",
    blog_p:
      "Analyses, tendances et perspectives sur l'IA en Afrique et dans le monde.",
    ...
    blog_newsletter_p:
      "Recevez nos analyses IA directement dans votre boîte mail.",
    ...
    projects_cta_p:
      "Parlons de votre défi et construisons la solution qui fera la différence.",
    solutions_label: "// Solutions Sectorielles",
    solutions_h1: "Solutions IA",
    solutions_h1_2: "Sectorielles",
    solutions_p:
      "Des solutions conçues pour les défis de chaque secteur en Afrique.",
    ...
    sol_finance_feat1_p:
      "Modèles ML temps réel avec 99.2% de précision, réduisant les pertes de 70%.",
    sol_finance_feat2: "Scoring de Crédit IA",
    sol_finance_feat2_p:
      "Évaluation automatisée du risque crédit intégrant données alternatives.",
    sol_finance_feat3: "Prévision de Liquidité",
    sol_finance_feat3_p:
      "Anticipez vos besoins en trésorerie avec une précision de 95%.",
    ...
    partners_p:
      "Un réseau mondial de partenaires technologiques, académiques et institutionnels.",
    ...
    partners_become_p:
      "Vous souhaitez rejoindre notre écosystème ? Discutons des opportunités.",
    testimonials_label: "// Témoignages",
    testimonials_h1: "Ce que disent",
    testimonials_h1_2: "nos clients",
    testimonials_p:
      "Plus de 50 entreprises nous font confiance à travers l'Afrique et au-delà.",
    ...
    research_p:
      "Nos équipes contribuent activement à la recherche en IA, avec un focus sur les défis africains.",
    research_area1_title: "IA pour les Langues Africaines",
    research_area1_p:
      "Modèles NLP adaptés au Wolof, Bambara, Dioula et autres langues locales.",
    research_area2_title: "IA Frugale pour Mobiles",
    research_area2_p:
      "Optimisation de modèles ML pour appareils à faible consommation en zones rurales.",
    research_area3_title: "Prévision Climatique Sahélienne",
    research_area3_p:
      "Modèles spécialisés pour les conditions météo de l'Afrique de l'Ouest.",
    research_area4_title: "Santé Connectée Africaine",
    research_area4_p:
      "Diagnostic assisté par IA adapté aux infrastructures de santé locales.",
    ...
    privacy_s2_p:
      "Vos données sont utilisées exclusivement dans le cadre de nos services.",
    privacy_s3_title: "3. Sécurité",
    privacy_s3_p:
      "Chiffrement des données, contrôles d'accès stricts, audits réguliers et conformité RGPD.",
    privacy_s4_title: "4. Vos Droits",
    privacy_s4_p:
      "Accès, rectification, suppression et portabilité de vos données sur simple demande.",
    privacy_s5_title: "5. Cookies",
    privacy_s5_p:
      "Nous utilisons des cookies fonctionnels et analytiques désactivables dans votre navigateur.",
    privacy_s6_title: "6. Contact DPO",
    privacy_s6_p:
      "Pour toute question sur vos données, contactez notre DPO à privacy@emiasn.sn.",
    contact_h1: "Travaillons",
    contact_h1_2: "Ensemble",
    contact_p:
      "Parlez-nous de votre projet. Notre équipe revient vers vous en moins de 24h.",
  ...
  en: {
    ...
    serv_cv_desc:
      "Real-time image and video analysis for automation and quality control.",
    serv_cta_title: "A project in mind?",
    serv_cta_p:
      "Let's discuss your needs and build the right AI solution together.",
    ...
    projects_cta_p:
      "Let's talk about your challenge and build the solution that makes a difference.",
    solutions_label: "// Industry Solutions",
    solutions_h1: "AI Solutions",
    solutions_h1_2: "by Industry",
    solutions_p:
      "Solutions designed for the challenges of each sector in Africa.",
    ...
    sol_finance_feat1_p:
      "Real-time ML models with 99.2% accuracy, reducing losses by 70%.",
    sol_finance_feat2: "AI Credit Scoring",
    sol_finance_feat2_p:
      "Automated credit risk assessment integrating alternative data.",
    ...
    partners_p:
      "A global network of technological, academic and institutional partners.",
    partners_univ_title: "Partner Universities",
    partners_rd_title: "R&D & Research",
    partners_cloud_title: "Cloud & Infrastructure",
    partners_become_title: "Become a Partner",
    partners_become_p:
      "Want to join our ecosystem? Let's discuss collaboration opportunities.",
    ...
    research_p:
      "Our teams actively contribute to AI research, focusing on African challenges.",
    research_area1_title: "AI for African Languages",
    research_area1_p:
      "NLP models adapted to Wolof, Bambara, Dioula and other local languages.",
    research_area2_title: "Frugal AI for Mobile",
    research_area2_p:
      "ML model optimization for low-power devices in rural areas.",
    ...
    research_area4_p:
      "AI-assisted diagnostics adapted to local health infrastructure.",
    research_pub_label: "// Publications",
    ...
    privacy_s2_p:
      "Your data is used exclusively within the framework of our services.",
    privacy_s3_title: "3. Security",
    privacy_s3_p:
      "Data encryption, strict access controls, regular audits and GDPR compliance.",
    privacy_s4_title: "4. Your Rights",
    privacy_s4_p:
      "Access, rectification, deletion and portability of your data on request.",
    privacy_s5_title: "5. Cookies",
    privacy_s5_p:
      "We use functional and analytical cookies. You can disable them in your browser settings.",
    privacy_s6_title: "6. DPO Contact",
    privacy_s6_p:
      "For any questions about your personal data, contact our DPO at privacy@emiasn.sn.",
    contact_h1: "Let's work",
    contact_h1_2: "Together",
    contact_p:
      "Tell us about your project. Our team gets back to you in less than 24h.",
  ...
  ar: {
    ...
    nav: {
      ...
      serv_cv_desc:
        "تحليل الصور والفيديو في الوقت الفعلي للأتمتة ومراقبة الجودة.",
      serv_cta_title: "هل لديك مشروع في ذهنك؟",
      serv_cta_p:
        "دعنا نناقش احتياجاتك ونبني معاً حل الذكاء الاصطناعي المناسب.",
      ...
      blog_newsletter_p:
        "احصل على تحليلات الذكاء الاصطناعي مباشرة في صندوق بريدك.",
      ...
      sol_finance_feat2_p:
        "تقييم مخاطر الائتمان الآلي مع دمج البيانات البديلة.",
      ...
      partners_p:
        "شبكة عالمية من الشركاء التكنولوجيين والأكاديميين والمؤسسيين.",
      ...
      partners_become_p:
        "هل تريد الانضمام إلى نظامنا البيئي؟ دعنا نناقش فرص التعاون.",
      ...
      research_h1_2: "البحث",
      research_p:
        "يساهم فريقنا بنشاط في أبحاث الذكاء الاصطناعي مع التركيز على التحديات الأفريقية.",
      ...
      research_area4_p:
        "تشخيص بمساعدة الذكاء الاصطناعي مكيف مع البنية الصحية المحلية.",
      ...
      privacy_s5_p:
        "نستخدم ملفات تعريف ارتباط وظيفية وتحليلية يمكن تعطيلها في إعدادات المتصفح.",
      privacy_s6_title: "6. جهة الاتصال DPO",
      privacy_s6_p:
        "لأي أسئلة تتعلق ببياناتك، تواصل مع مسؤول حماية بياناتنا على privacy@emiasn.sn.",
      contact_h1: "لنعمل",
      contact_h1_2: "معاً",
...
const PT = {
  fr: {
    ...
    form_error_send: "Échec de l'envoi. Écrivez à ibrahima.ndao@emiasn.com",
    // ABOUT
    ...
    timeline_2019_desc:
      "Création à Dakar par une équipe de data scientists et ingénieurs IA formés en Europe et aux États-Unis.",
    timeline_2020_title: "Premiers Grands Comptes",
    timeline_2020_desc:
      "Signature des premiers contrats dans les secteurs bancaire et télécoms au Sénégal.",
    timeline_2021_title: "Expansion Régionale",
    timeline_2021_desc:
      "Ouverture de bureaux à Abidjan, Bamako et Conakry. Extension de l'équipe à 20 experts IA.",
    timeline_2023_title: "Reconnaissance Internationale",
    timeline_2023_desc:
      "Prix de l'Innovation Numérique Africaine. Partenariats avec universités européennes pour la R&D.",
    timeline_2024_date: "2024 – Aujourd'hui",
    timeline_2024_title: "Leader IA Africain",
    timeline_2024_desc:
      "30+ experts, 50+ projets livrés, présence dans 5 pays. En route vers l'expansion européenne.",
    // TEAM page
    ...
    team_zakaria_desc:
      "Fondateur de EMIASN, Professeur et Enseignant. Ayant travaillé dans les secteurs de la Banque, l'industrie et tant d'autres domaines, Zakaria unit expertise pluridisciplinaire et vision stratégique pour bâtir l'IA de demain en Afrique.",
    ...
    team_ibrahima_desc:
      "Directeur Technique EMIASN à l'échelle mondiale, Ibrahima est le Tech Lead de toutes les agences EMIASN dans le monde. Il pilote l'architecture des solutions IA, coordonne les équipes d'ingénierie globales et garantit l'excellence technique de chaque livrable.",
    ...
    team_mouhamadou_desc:
      "Tech Lead Support Client World Wide, Mouhamadou Moustapha gère l'ensemble du support technique international d'EMIASN. Enseignant dans les Écoles d'ingénieur et dans les entreprises en Data Science et Intelligence Artificielle, il allie expertise terrain et transmission du savoir.",
    ...
    team_sekou_desc:
      "Expert en cybersécurité et ingénieur Data Science & IA, Sékou allie maîtrise des infrastructures sécurisées et expertise algorithmique. Il conçoit des systèmes IA robustes tout en garantissant la protection des données et des modèles déployés en production chez les clients d'EMIASN.",
    ...
    team_tamsir_desc:
      "Porteur de vision et donneur d'ordres pour toute la zone EMEA depuis Paris. Adjoint au consul de Paris, il coordonne les opérations EMIASN à travers l'Europe, le Moyen-Orient et l'Afrique. Passionné de Data Science, il s'engage personnellement dans les challenges EMIASN.",
    ...
    team_mohamed_desc:
      "Responsable du Management des Systèmes d'Information d'EMIASN, de tous les projets EMIASN et de la sécurité de toutes les infrastructures World Wide. Interface directe avec l'ensemble des clients EMIASN.",
    ...
    team_idrissa_desc:
      "Directeur et Manager des Grands Comptes Clients chez EMIASN, Idrissa Gassama est un cadre de haute expérience, ancien cadre de Sonatel. Il prend en charge le Marketing et les Business Units d'EMIASN, en pilotant la stratégie commerciale et le développement des relations avec les grandes entreprises clientes.",
    ...
    team_culture_intro:
      "Chez EMIASN, nous croyons que les grandes idées naissent dans un cadre qui valorise la diversité, l'autonomie et l'apprentissage continu.",
    ...
    team_quote:
      "«Notre mission est de prouver que l'Afrique peut mener la révolution IA mondiale, pas seulement y participer.»",
    team_cta_badge: "Nous recrutons",
    team_cta_h2: "Votre talent a sa place<br/>chez EMIASN",
    team_cta_p:
      "Rejoignez les pionniers de l'IA en Afrique de l'Ouest. Postes ouverts en Data Science, ML Engineering, NLP et plus.",
    ...
    serv_ml_desc:
      "Algorithmes supervisés et non-supervisés avec Scikit-Learn. Régression, SVM, Random Forest, Gradient Boosting…",
    serv_dl_title: "Deep Learning",
    serv_dl_subtitle: "CNN · RNN · Transformers",
    serv_dl_desc:
      "Architectures de réseaux profonds avec TensorFlow et Keras : reconnaissance d'images, génération de texte, séries temporelles.",
    serv_ds_title: "Data Science & Analytics",
    serv_ds_subtitle: "EDA · Visualisation · Insights",
    serv_ds_desc:
      "Exploration avec NumPy, Pandas. Visualisation interactive avec Matplotlib et Seaborn pour des rapports décisionnels.",
    serv_cv_title: "Computer Vision",
    serv_cv_subtitle: "Détection · Reconnaissance · Segmentation",
    serv_cv_desc:
      "Solutions de vision par ordinateur pour la sécurité, contrôle qualité et surveillance. Détection d'objets en temps réel.",
    serv_nlp_title: "NLP & Traitement du Langage",
    serv_nlp_subtitle: "Analyse · Génération · Chatbots",
    serv_nlp_desc:
      "Analyse de sentiment, extraction d'entités, chatbots intelligents et traduction en français, anglais et wolof.",
    serv_mlops_title: "MLOps & Déploiement",
    serv_mlops_subtitle: "Pipeline · Production · Monitoring",
    serv_mlops_desc:
      "Mise en production CI/CD, monitoring des performances, gestion du drift et scalabilité cloud ou on-premise.",
    hero_badge_text: "Pionniers de l'IA en Afrique",
    hero_tagline: "Intelligence Artificielle · Dakar, Sénégal · Global",
    hero_cta_primary: "Découvrir nos Solutions",
    hero_cta_secondary: "Nous Contacter",
    ...
    partners_become_title: "Devenez Partenaire",
    partners_become_p:
      "Rejoignez notre écosystème et discutons des opportunités.",
    testimonials_label: "// Témoignages",
    testimonials_h1: "Ce que disent",
    testimonials_h1_2: "nos clients",
    testimonials_p:
    ...
    research_h1_2: "Recherche",
    research_p:
      "Nos équipes contribuent à la recherche en IA avec un focus sur les défis africains.",
    research_area1_title: "IA pour les Langues Africaines",
    research_area1_p:
      "Modèles NLP adaptés au Wolof, Bambara, Dioula et autres langues locales.",
    research_area2_title: "IA Frugale pour Mobiles",
    ...
    sol_tel_feat1_p:
      "Identification proactive des clients à risque de désabonnement.",
    sol_tel_feat2: "Optimisation Réseau",
    sol_tel_feat2_p:
      "Gestion dynamique de la bande passante et prédiction des pannes.",
    sol_tel_feat3: "Personnalisation d'Offres",
    sol_tel_feat3_p:
      "Recommandations en temps réel selon les comportements d'usage.",
    sol_san_feat1: "Diagnostic Assisté",
    sol_san_feat1_p:
      "Analyse d'imagerie médicale pour l'aide au diagnostic des maladies tropicales.",
    ...
    sol_san_feat3_p:
      "Optimisation IA pour éviter les ruptures de médicaments essentiels.",
    sol_agri_feat2: "Détection de Maladies",
    sol_agri_feat2_p:
      "Vision par ordinateur pour détecter les maladies des cultures via drones.",
    ...
    sol_retail_feat1_p:
      "Moteurs personnalisés augmentant panier moyen et fidélisation.",
    sol_retail_feat2: "Gestion des Stocks",
    sol_retail_feat2_p:
      "Prédiction de la demande et optimisation automatique des niveaux.",
    ...
    research_area4_p:
      "Détection précoce des maladies endémiques via l'imagerie médicale.",
  },
  en: {
    contact_label: "// Contact",
    ...
    form_error_send: "Failed to send. Email us at ibrahima.ndao@emiasn.com",
    ...
    timeline_2019_desc:
      "Created in Dakar by a team of data scientists and AI engineers trained in Europe and the United States.",
    timeline_2020_title: "First Major Accounts",
    timeline_2020_desc:
      "Signing of first contracts in the banking and telecoms sectors in Senegal.",
    timeline_2021_title: "Regional Expansion",
    timeline_2021_desc:
      "Opening of offices in Abidjan, Bamako and Conakry. Team expanded to 20 AI experts.",
    timeline_2023_title: "International Recognition",
    timeline_2023_desc:
      "African Digital Innovation Award. Partnerships with European universities for R&D.",
    timeline_2024_date: "2024 – Present",
    timeline_2024_title: "African AI Leader",
    timeline_2024_desc:
      "30+ experts, 50+ projects delivered, presence in 5 countries. On the way to European expansion.",
    // TEAM page
    ...
    team_zakaria_desc:
      "Founder of EMIASN, Professor and Educator. Having worked in the banking, industrial and many other sectors, Zakaria combines multidisciplinary expertise and strategic vision to build tomorrow's AI in Africa.",
    ...
    team_ibrahima_desc:
      "Chief Technical Officer of EMIASN at global scale, Ibrahima is the Tech Lead for all EMIASN offices worldwide. He pilots AI solution architecture, coordinates global engineering teams and ensures technical excellence in every deliverable.",
    ...
    team_mouhamadou_desc:
      "Tech Lead for Client Support Worldwide, Mouhamadou Moustapha manages all international technical support for EMIASN. Teaching at engineering schools and in companies on Data Science and Artificial Intelligence, he combines field expertise with knowledge transfer.",
    team_mouhamadou_tag1: "Support WW",
    ...
    team_sekou_desc:
      "Cybersecurity expert and Data Science & AI engineer, Sékou combines mastery of secure infrastructures with algorithmic expertise. He designs robust AI systems while ensuring the protection of data and models deployed in production for EMIASN's clients.",
    ...
    team_tamsir_region: "Europe · Middle East · Africa",
    team_tamsir_desc:
      "Vision leader and decision-maker for the entire EMEA region from Paris. Deputy Consul of Paris, he coordinates EMIASN operations across Europe, the Middle East and Africa. Passionate about Data Science, he personally engages in EMIASN challenges.",
    team_tamsir_tag1: "EMEA Strategy",
    team_tamsir_tag2: "Paris · Europe",
    team_tamsir_tag3: "Data Science",
    team_mohamed_title:
      "MSI EMIASN · All Projects · Infrastructure Security WW",
    team_mohamed_contact: "In contact with all clients",
    team_mohamed_desc:
      "Manager of Information Systems for EMIASN, all EMIASN projects and security of all worldwide infrastructure. Direct interface with all EMIASN clients.",
    team_mohamed_tag1: "MSI EMIASN",
    ...
    team_idrissa_desc:
      "Director and Manager of Key Client Accounts at EMIASN, Idrissa Gassama is a highly experienced executive and former senior manager at Sonatel. He oversees Marketing and Business Units at EMIASN, steering the commercial strategy and developing relationships with major corporate clients.",
    ...
    team_culture_intro:
      "At EMIASN, we believe great ideas are born in an environment that values diversity, autonomy and continuous learning.",
    ...
    team_quote:
      "«Our mission is to prove that Africa can lead the global AI revolution, not just participate in it.»",
    team_cta_badge: "We are hiring",
    team_cta_h2: "Your talent belongs<br/>at EMIASN",
    team_cta_p:
      "Join the pioneers of AI in West Africa. Open positions in Data Science, ML Engineering, NLP and more.",
    ...
    serv_ml_desc:
      "Supervised and unsupervised algorithms with Scikit-Learn. Regression, SVM, Random Forest, Gradient Boosting…",
    serv_dl_title: "Deep Learning",
    serv_dl_subtitle: "CNN · RNN · Transformers",
    serv_dl_desc:
      "Deep neural network architectures with TensorFlow and Keras: image recognition, text generation, time series.",
    serv_ds_title: "Data Science & Analytics",
    serv_ds_subtitle: "EDA · Visualization · Insights",
    serv_ds_desc:
      "Exploration with NumPy, Pandas. Interactive visualization with Matplotlib and Seaborn for decision reports.",
    serv_cv_title: "Computer Vision",
    serv_cv_subtitle: "Detection · Recognition · Segmentation",
    serv_cv_desc:
      "Computer vision solutions for security, quality control and surveillance. Real-time object detection.",
    serv_nlp_title: "NLP & Language Processing",
    serv_nlp_subtitle: "Analysis · Generation · Chatbots",
    serv_nlp_desc:
      "Sentiment analysis, entity extraction, intelligent chatbots and translation in French, English and Wolof.",
    serv_mlops_title: "MLOps & Deployment",
    serv_mlops_subtitle: "Pipeline · Production · Monitoring",
    serv_mlops_desc:
      "CI/CD production deployment, performance monitoring, drift management and cloud or on-premise scalability.",
    hero_badge_text: "AI Pioneers in Africa",
    hero_tagline: "Artificial Intelligence · Dakar, Senegal · Global",
    hero_cta_primary: "Explore our Solutions",
    hero_cta_secondary: "Contact Us",
    ...
    careers_benefit1_title: "Continuous Training",
    careers_benefit1_p:
      "Training budget + certifications Google, AWS, Microsoft",
    careers_benefit2_title: "Global Impact",
    careers_benefit2_p: "Projects with international reach",
    careers_benefit3_title: "Flexibility",
    careers_benefit3_p: "Hybrid remote work, flexible hours",
    ...
    partners_become_title: "Become a Partner",
    partners_become_p:
      "Join our ecosystem and let's discuss collaboration opportunities.",
    testimonials_label: "// Testimonials",
    testimonials_h1: "What our",
    testimonials_h1_2: "clients say",
    testimonials_p: "More than 50 companies trust us across Africa and beyond.",
    ...
    privacy_s6_title: "6. DPO Contact",
    privacy_s6_p:
      "For any questions about your data, contact our DPO at privacy@emiasn.sn.",
    contact_h1: "Let's work",
    contact_opt_project: "AI Project",
    contact_opt_partner: "Partnership",
    contact_opt_press: "Press",
    ...
    sol_tel_feat1_p:
      "Proactive identification of customers at risk of unsubscribing.",
    ...
    sol_san_feat1_p:
      "Medical imaging analysis to assist diagnosis of tropical diseases.",
    ...
    sol_san_feat3_p:
      "AI optimization to prevent shortages of essential medicines.",
    ...
    sol_retail_feat1_p:
      "Personalized engines increasing average basket and loyalty.",
    ...
    research_area4_p:
      "Early detection of endemic diseases through medical imaging.",
  },
  ar: {
    ...
    form_error_send: "فشل الإرسال. راسلنا على ibrahima.ndao@emiasn.com",
    ...
    timeline_2019_desc:
      "تأسست في داكار على يد فريق من علماء البيانات ومهندسي الذكاء الاصطناعي المتدربين في أوروبا والولايات المتحدة.",
    timeline_2020_title: "أول العملاء الكبار",
    timeline_2020_desc:
      "توقيع أول العقود في قطاعي البنوك والاتصالات في السنغال.",
    timeline_2021_title: "التوسع الإقليمي",
    timeline_2021_desc:
      "افتتاح مكاتب في أبيدجان وباماكو وكوناكري. توسعت الفريق إلى 20 خبيراً في الذكاء الاصطناعي.",
    timeline_2023_title: "الاعتراف الدولي",
    timeline_2023_desc:
      "جائزة الابتكار الرقمي الأفريقي. شراكات مع جامعات أوروبية للبحث والتطوير.",
    timeline_2024_date: "2024 – الآن",
    timeline_2024_title: "رائد الذكاء الاصطناعي الأفريقي",
    timeline_2024_desc:
      "أكثر من 30 خبيراً و50+ مشروع مسلّم، حضور في 5 دول. في طريقنا نحو التوسع الأوروبي.",
    // TEAM page
    ...
    team_zakaria_desc:
      "مؤسس EMIASN، أستاذ ومعلم. بعد عمله في قطاعات البنوك والصناعة وغيرها، يجمع زكاريا بين الخبرة المتعددة التخصصات والرؤية الاستراتيجية لبناء ذكاء اصطناعي المستقبل في أفريقيا.",
    ...
    team_ibrahima_desc:
      "مدير التكنولوجيا بمنظمة EMIASN على المستوى العالمي، إبراهيما هو Tech Lead لجميع مكاتب EMIASN حول العالم. يقود معمارية حلول الذكاء الاصطناعي ويوجه فرق الهندسة العالمية ويضمن التميز التقني في كل ما نقدمه.",
    ...
    team_mouhamadou_desc:
      "Tech Lead لدعم العملاء عالمياً، يدير Mouhamadou Moustapha جميع الدعم التقني الدولي لـ EMIASN. معلم في المدارس الهندسية والشركات في Data Science والذكاء الاصطناعي، يجمع بين الخبرة الميدانية ونقل المعرفة.",
    ...
    team_sekou_desc:
      "خبير في الأمن السيبراني ومهندس علوم البيانات والذكاء الاصطناعي، يجمع سيكو بين إتقان البنى التحتية الآمنة والخبرة الخوارزمية. يصمم أنظمة ذكاء اصطناعي متينة مع ضمان حماية البيانات والنماذج المنشورة في بيئة الإنتاج لدى عملاء EMIASN.",
    ...
    team_tamsir_title:
      "مدير EMIASN فرنسا والمنطقة الأوروبية الشرق أوسطية الأفريقية",
    team_tamsir_region: "أوروبا · الشرق الأوسط · أفريقيا",
    team_tamsir_desc:
      "قائد الرؤية وصاحب القرار للمنطقة الأوروبية الشرق أوسطية الأفريقية بأكملها من باريس. قنصل فرنسا بباريس، يوجه عمليات EMIASN عبر أوروبا والشرق الأوسط وأفريقيا. شغوف بـ Data Science، يشارك شخصياً في تحديات EMIASN.",
    team_tamsir_tag1: "استراتيجية المنطقة",
    team_tamsir_tag2: "باريس · أوروبا",
    team_tamsir_tag3: "Data Science",
    team_mohamed_title:
      "إدارة أنظمة المعلومات · جميع المشاريع · أمان البنية التحتية العالمي",
    team_mohamed_contact: "على اتصال مع جميع العملاء",
    team_mohamed_desc:
      "مسؤول إدارة أنظمة المعلومات بـ EMIASN وجميع مشاريع EMIASN وأمان جميع البنى التحتية العالمية. واجهة مباشرة مع جميع عملاء EMIASN.",
    ...
    team_idrissa_desc:
      "مدير الحسابات الكبرى ومسيرها في EMIASN، إدريسا غاساما إطار رفيع المستوى وكادر سابق في سوناتيل. يتولى إشراف التسويق ووحدات الأعمال في EMIASN، مع قيادة الاستراتيجية التجارية وتطوير العلاقات مع كبار العملاء من الشركات.",
    ...
    team_culture_intro:
      "في EMIASN، نؤمن أن الأفكار العظيمة تولد في بيئة تقدر التنوع والاستقلالية والتعلم المستمر.",
    ...
    team_quote:
      "«مهمتنا هي إثبات أن أفريقيا يمكنها قيادة ثورة الذكاء الاصطناعي العالمية، وليس مجرد المشاركة فيها.»",
    team_cta_badge: "نحن نوظف",
    team_cta_h2: "موهبتك لها مكان<br/>في EMIASN",
    team_cta_p:
      "انضم إلى رواد الذكاء الاصطناعي في غرب أفريقيا. وظائف مفتوحة في Data Science و ML Engineering و NLP والمزيد.",
    ...
    serv_ml_desc:
      "خوارزميات موجهة وغير موجهة مع Scikit-Learn. الانحدار، SVM، Random Forest، Gradient Boosting…",
    serv_dl_title: "التعلم العميق",
    serv_dl_subtitle: "CNN · RNN · Transformers",
    serv_dl_desc:
      "معماريات الشبكات العصبية العميقة مع TensorFlow و Keras: التعرف على الصور، توليد النصوص، السلاسل الزمنية.",
    serv_ds_title: "Data Science والتحليلات",
    serv_ds_subtitle: "استكشاف · تصور · رؤى",
    serv_ds_desc:
      "الاستكشاف مع NumPy و Pandas. التصور التفاعلي مع Matplotlib و Seaborn لتقارير القرار.",
    serv_cv_title: "رؤية الحاسوب",
    serv_cv_subtitle: "الكشف · التعرف · التجزئة",
    serv_cv_desc:
      "حلول رؤية الحاسوب للأمان والتحكم في الجودة والمراقبة. كشف الأشياء في الوقت الفعلي.",
    serv_nlp_title: "معالجة اللغة الطبيعية والترجمة",
    serv_nlp_subtitle: "التحليل · التوليد · روبوتات الدردشة",
    serv_nlp_desc:
      "تحليل المشاعر واستخراج الكيانات وروبوتات دردشة ذكية والترجمة إلى الفرنسية والإنجليزية والولوف.",
    serv_mlops_title: "MLOps والنشر",
    serv_mlops_subtitle: "خط أنابيب · الإنتاج · المراقبة",
    serv_mlops_desc:
      "نشر الإنتاج CI/CD ومراقبة الأداء وإدارة الانجراف وقابلية التوسع السحابية أو المحلية.",
    hero_badge_text: "رواد الذكاء الاصطناعي في أفريقيا",
    hero_tagline: "الذكاء الاصطناعي · داكار، السنغال · عالمي",
    hero_cta_primary: "اكتشف حلولنا",
    hero_cta_secondary: "تواصل معنا",
    ...
    research_h1_2: "البحث",
    research_p:
      "يساهم فريقنا في أبحاث الذكاء الاصطناعي مع التركيز على التحديات الأفريقية.",
    research_area1_title: "الذكاء الاصطناعي للغات الأفريقية",
    research_area1_p: "نماذج NLP مكيفة للغات الولوف والبامبارا والديولا.",
    research_area2_title: "الذكاء الاصطناعي الاقتصادي للهاتف",
    research_area2_p: "تحسين نماذج التعلم الآلي للأجهزة منخفضة الاستهلاك.",
    ...
    sol_tel_feat1_p:
      "التعرف الاستباقي على العملاء المعرضين لخطر إلغاء الاشتراك.",
    ...
    sol_agri_feat2_p:
      "رؤية الحاسوب للكشف عن أمراض المحاصيل عبر الطائرات المسيّرة.",
    ...
    <div class="grid md:grid-cols-4 gap-10 mb-12">
      ...
      <div>
        ...
        <div class="space-y-3 text-sm text-muted">
          ...
          <div class="flex items-center gap-2"><i class="fas fa-envelope text-primary text-xs shrink-0"></i><a href="mailto:ibrahima.ndao@emiasn.com" class="hover:text-primary transition-colors break-all">ibrahima.ndao@emiasn.com</a></div>
...
// ════════════════════════════════════════════════
//  CONTACT FORM  – Web3Forms (emails → ibrahima.ndao@emiasn.com)
...
async function sendContactForm() {
  ...
  const fname = truncate(
    document.getElementById("contact-fname")?.value.trim() || "",
    100,
  );
  const lname = truncate(
    document.getElementById("contact-lname")?.value.trim() || "",
    100,
  );
  const emailVal = truncate(
    document.getElementById("contact-email")?.value.trim() || "",
    254,
  );
  const company = truncate(
    sanitize(document.getElementById("contact-company")?.value.trim() || ""),
    200,
  );
  const subjectEl = document.getElementById("contact-subject");
  const subject = sanitize(
    subjectEl?.options[subjectEl.selectedIndex]?.text || "Contact",
  );
  const message = truncate(
    sanitize(document.getElementById("contact-message")?.value.trim() || ""),
    5000,
  );
  ...
  if (!emailVal || !message) {
    showToast(
      "⚠️ " +
        (t("form_error_required") || "Veuillez remplir l'email et le message."),
    );
    return;
  }
  const emailRe = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  ...
  if (WEB3FORMS_KEY === "VOTRE_CLE_ICI") {
    ...
    window.location.href = `mailto:ibrahima.ndao@emiasn.com?subject=${encodeURIComponent("EMIASN – " + subject)}&body=${encodeURIComponent(body)}`;
    setTimeout(() => {
  ...
  try {
    ...
    showToast(
      "❌ " +
        (t("form_error_send") ||
          "Échec de l'envoi. Réessayez ou écrivez à ibrahima.ndao@emiasn.com"),
    );
  } finally {
    resetContactForm(btn, btnText, btnIcon);
  }
