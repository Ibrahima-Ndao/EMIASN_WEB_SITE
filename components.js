...
const PT = {
  fr: {
    ...
    faq_a6:
      "Oui, bureaux à Dakar, Abidjan, Bamako et Paris. Nos équipes opèrent en remote pour des clients en Europe, Asie et Amérique du Nord.",
    // TEAM
    ...
    timeline_2021_desc: "Ouverture de bureaux à Abidjan et Bamako. Extension de l'équipe à 20 experts IA.",
  ...
  en: {
    ...
    faq_a6:
      "Yes, offices in Dakar, Abidjan, Bamako and Paris. Our teams work remotely for clients in Europe, Asia and North America.",
    team_label: "// Our Team",
    team_h1_1: "The Minds",
    ...
    timeline_2021_desc: "Opening of offices in Abidjan and Bamako. Team expanded to 20 AI experts.",
  ...
  ar: {
    ...
    timeline_2021_desc: "افتتاح مكاتب في أبيدجان وباماكو. توسعت الفريق إلى 20 خبيراً في الذكاء الاصطناعي.",
