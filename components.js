...
const PT = {
  fr: {
    ...
    team_idrissa_desc: "Pilier commercial d'EMIASN, Idrissa pilote la stratégie grands comptes et l'ensemble des relations clients. Fort d'une expérience solide en business development, il développe et fidélise le portefeuille clients d'EMIASN à l'échelle régionale et internationale.",
  ...
  en: {
    ...
    team_idrissa_desc: "EMIASN's commercial backbone, Idrissa drives the key accounts strategy and all client relationships. With solid business development experience, he grows and retains EMIASN's client portfolio at regional and international scale.",
  ...
  ar: {
    ...
    team_idrissa_desc: "الركيزة التجارية لـ EMIASN، يقود إدريسا استراتيجية الحسابات الكبرى وجميع علاقات العملاء. بفضل خبرته الراسخة في تطوير الأعمال، يُنمّي محفظة عملاء EMIASN ويحافظ عليها على المستوى الإقليمي والدولي.",
